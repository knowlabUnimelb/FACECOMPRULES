// CONDITION ONE FOR SPLIT-ALIGNED FACE EXPERIMENTS - UPRIGHT MISALIGNED FACES
...
function validateResponse() {	
    ...
    // exp_data["rt"] = rt;
    exp_data["experiment"] = "FACE_COMP_MDS_con2";
...
function saveData(args) {
	...
	data: {"table": "facecomp_con2", "json": JSON.stringify(data)}, // Table refers to the name of the table in the db
