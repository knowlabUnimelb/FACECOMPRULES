// CONDITION ONE FOR SPLIT-ALIGNED FACE EXPERIMENTS - UPRIGHT ALIGNED FACES
...
function validateResponse() {	
    ...
    // exp_data["rt"] = rt;
    exp_data["experiment"] = "FACE_COMP_MDS_con1";
...
function saveData(args) {
	...
	data: {"table": "facecomp_con1", "json": JSON.stringify(data)}, // Table refers to the name of the table in the db
