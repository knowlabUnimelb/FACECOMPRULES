...
trainingInstructions = {'Instructions (1).bmp', sprintf('Instructions Condition %d.bmp', condition)};
...
for bblocks = 1:nBlocks
    ...
    % Flip A's and B's - I have to do this because I've reversed the categories in the instructions and in feedbackprobs. This will make the output commensurate with the existing analysis programs
...
overallAcc = sum(finaloutput(:,end-1))./numel(finaloutput(:,end-1));
