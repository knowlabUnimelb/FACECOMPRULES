...
for idx = chainSet
    ...
    chain(idx).newlike =  logDensLikeFD(chain(idx).proptheta, data, model); % Weight for the current sample is the target probability of that sample (i.e., likelihood x prior)
